...
def create_experiment_data() -> None:
    ...
    """
    # define problem sets
    problem_sets = ['mf_Bohachevsky', 'mf_Booth',
                    'mf_Hartman3', 'mf_Hartman6', 'mf_Himmelblau',
                    'mf_Sixhump']
    # define seed sets
    ...
    domain.add('num_sample', DiscreteParameter(lower_bound=2, upper_bound=40))
...
def run_method(
    ...
    # define kernel
    model = get_method(method_name="kriging", design_space=func.input_domain)
